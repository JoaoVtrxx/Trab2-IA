...
def depth_impact_analysis(depths: List[int] = [3, 4, 5],
    ...
    for depth in depths:
        ...
        print(f"  Profundidade {depth}: MinMax vence {wins_mm}/{n_games} "
...
# ---------------------------------------------------------------------------
# Demo de uma única partida com verbose
# ---------------------------------------------------------------------------

def demo_single_game(verbose_mm: bool = True) -> None:
    """
